...
def carregar_dados_merged(
    ...
    # Concat without aligning columns (keeps all columns)
...
de_para_mantenedor: Dict[str, str] = {
    ...
    "HENRIQUE, THIAGO - CM2 COMERCIO E SERVIÇOS LTDA EPP":"CM2",
    "EVANDRO, - FLOTECK COMERCIO E SERVIÇOS ESPECIALIZADOS LTDA":"FLOTECK",
    "RIGOBERTO, FRANCISCO - F R RIBEIRO MECANICA SAO CRISTOVAO SERVIÇOS ELETRONICOS LTDA":"MEC. SÃO CRISTÓVÃO",
    ...
    "GONZAGA, MANOEL - LMG COMERCIO SERVIÇOS E MANUTENCAO LTDA":"LMG",
    ...
    "MENEZES SOARES, ALTEVIR - JUMPER SERVIÇOS TECNICOS DE BOMBAS DE COMBUSTIVEIS LTDA":"JUMPER",
    ...
    "COSTA, HELIO - REAL MANUTENCAO E INSTALACAO EM POSTOS E SERVIÇOS LTDA":"REAL MANUTENÇÃO",
    ...
    "ANDRADE, JAIR - JMA PRESTADORA DE SERVIÇOS LTDA":"JMA",
    "ANDREZA, - UBERPOSTOS LOGISTICA E EQUIP":"UBERPOSTOS",
    "LUZENILDO, - DANTEC ASSITENCIA TECNICA LTDA":"DANTEC",
    "SANTANA, DORLAN - TECHPETRO SOLUCOES SERVIÇOS DE MANUTENCAO LTDA":"TECHPETRO",
    "SOARES, ALTEVIR - JUMPER MATERIAIS E SERVIÇOS PARA POSTOS DE COMBUSTIVEIS EIRELI ME":"JUMPER",
    ...
    "DOS SANTOS, GIVONI NATASHA - ATLAS COMERCIO DE MATERIAL ELETRICO E SERVIÇOS DE INSTALACAO LTDA":"ATLAS COMERCIO",
...
de_para_especialista: Dict[str, str] = {
    ...
    "GONZAGA, MANOEL - LMG COMERCIO SERVIÇOS E MANUTENCAO LTDA":"LUCIANO",
    ...
    "RIGOBERTO, FRANCISCO - F R RIBEIRO MECANICA SAO CRISTOVAO SERVIÇOS ELETRONICOS LTDA":"LUCIANO",
    ...
    "HENRIQUE, THIAGO - CM2 COMERCIO E SERVIÇOS LTDA EPP":"LUCAS",
    ...
    "COSTA, HELIO - REAL MANUTENCAO E INSTALACAO EM POSTOS E SERVIÇOS LTDA":"LUCIANO",
    ...
    "MENEZES SOARES, ALTEVIR - JUMPER SERVIÇOS TECNICOS DE BOMBAS DE COMBUSTIVEIS LTDA":"LUCIANO",
    "DO MONTE, CARLOS JORGE - PERMANENTE MANUTENCAO DE MAQUINAS E EQUIPAMENTOS EIRELI":"LUCIANO",
    "ANDRADE, JAIR - JMA PRESTADORA DE SERVIÇOS LTDA":"LUCAS",
    "BELARMINO, MARCOS - SOS SYSTEM TECNOLOGIA EM INFORMATICA LTDA":"LUCAS",
    "EVANDRO, - FLOTECK COMERCIO E SERVIÇOS ESPECIALIZADOS LTDA":"LUCAS",
    ...
    "SANTANA, DORLAN - TECHPETRO SOLUCOES SERVIÇOS DE MANUTENCAO LTDA":"LUCIANO",
   "SOARES, ALTEVIR - JUMPER MATERIAIS E SERVIÇOS PARA POSTOS DE COMBUSTIVEIS EIRELI ME":"LUCIANO",
    ...
    "DOS SANTOS, GIVONI NATASHA - ATLAS COMERCIO DE MATERIAL ELETRICO E SERVIÇOS DE INSTALACAO LTDA":"TBD",
